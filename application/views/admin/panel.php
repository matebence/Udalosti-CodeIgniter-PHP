...
<head>
    <meta charset="utf-8" />
    <link rel="icon" type="image/png" href="<?php echo base_url() . "node_modules/unofficial-light-bootstrap-dashboard/"; ?>assets/img/favicon.ico">
    ...
    <link href="<?php echo base_url() . "node_modules/unofficial-light-bootstrap-dashboard/"; ?>assets/css/demo.css" rel="stylesheet" />
...
<div class="wrapper">
    <div class="sidebar" data-color="purple" data-image="<?php echo base_url() . "node_modules/unofficial-light-bootstrap-dashboard/"; ?>assets/img/sidebar-5.jpg">
...
<!--   Core JS Files   -->
<script src="<?php echo base_url() . "node_modules/unofficial-light-bootstrap-dashboard/"; ?>assets/js/jquery.3.2.1.min.js" type="text/javascript"></script>
<script src="<?php echo base_url() . "node_modules/unofficial-light-bootstrap-dashboard/"; ?>assets/js/bootstrap.min.js" type="text/javascript"></script>
...
<script src="<?php echo base_url() . "node_modules/unofficial-light-bootstrap-dashboard/"; ?>assets/js/demo.js"></script>
